...
EXCEPTIONS="Sensors|FakePCIID_BCM57XX|FakePCIID_Intel_GbX|FakePCIID_Intel_HDMI|BrcmPatchRAM|BrcmBluetoothInjector|BrcmFirmwareData"
...
install_kext AppleHDA_CX20751-2.kext

#if [[ $MINOR_VER -ge 11 ]]; then
#    install_kext USBXHC_BRIX.kext
#fi
